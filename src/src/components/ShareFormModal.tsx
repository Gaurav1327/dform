export type ShareFormModalProps = {
  url: string,
  onClose: () => void
}

function ShareFormModal({ url, onClose }: ShareFormModalProps) {
return (
    <div className="bg-gray-100 w-full mx-4 p-4 rounded-xl">
      <div
      ...
      <div className="my-4">
        ...
        <div className="border-2 border-gray-200 flex justify-between items-center mt-4 py-2">
          ...
          <div className="w-full outline-none bg-transparent">{url}</div>
